...
public class MapContextMenu extends MenuTitleController implements StateChangedListener<ApplicationMode>,
	...
	public ContextMenuAdapter getActionsContextMenuAdapter(boolean configure) {
		...
		if (mapActivity != null) {
			...
			mapActivity.getMapActions().addActionsToAdapter(configure ? 0 : latLon.getLatitude(),
					configure ? 0 : latLon.getLongitude(), menuAdapter, configure ? null : getObject(), configure);
		}
		return menuAdapter;
	}
